...
export const VIDEOS = 'videos on Trader Mathews Bot';
...
export const user_guide_content: TUserGuideContent[] = [
    {
        ...
        type: 'Tour',
        subtype: 'OnBoard',
        content: localize('Get started on Trader Mathews Bot'),
...
export const guide_content: TGuideContent[] = [
    {
        id: 1,
        type: 'DBotVideo',
        content: localize('An introduction to Trader Mathews Bot'),
    ...
    },
    {
        id: 2,
        type: 'DBotVideo',
        content: localize('How to build a basic trading bot with Trader Mathews Bot'),
    ...
    },
    {
        id: 3,
        type: 'DBotVideo',
        content: localize('How to use Martingale strategy on Trader Mathews Bot'),
    ...
    },
    {
        id: 4,
        type: 'DBotVideo',
        content: localize('Introducing Accumulator Options on Trader Mathews Bot: Available for automated trading'),
...
export const faq_content: TFaqContent[] = [
    {
        title: localize('What is Trader Mathews Bot?'),
        description: [
            {
                type: 'text',
                content: localize(
    ...
    {
        title: localize('Do you offer pre-built trading bots on Trader Mathews Bot?'),
        description: [
            {
                type: 'text',
                content: localize(
        ...
        description: [
            {
                type: 'text',
                content: localize(
                    "A quick strategy is a ready-made strategy that you can use in Trader Mathews Bot. There are 3 quick strategies you can choose from: Martingale, D'Alembert, and Oscar's Grind."
                ),
            },
            {
                type: 'text',
    ...
    {
        title: localize('How do I import my own trading bot into Trader Mathews Bot?'),
        description: [
            {
                type: 'text',
                content: localize(
    ...
    {
        title: localize('How do I control my losses with Trader Mathews Bot?'),
        description: [
            {
                type: 'text',
                content: localize(
                    'There are several ways to control your losses with Trader Mathews Bot. Here’s a simple example of how you can implement loss control in your strategy:'
                ),
            },
            {
                type: 'image',
    ...
    {
        title: localize('Can I run Trader Mathews Bot on multiple tabs in my web browser?'),
        description: [
            {
                type: 'text',
                content: localize(
    ...
    {
        title: localize('Can I trade cryptocurrencies on Trader Mathews Bot?'),
        description: [
            {
                type: 'text',
                content: localize("No, we don't offer cryptocurrencies on Trader Mathews Bot."),
            },
        ],
        search_id: 'faq-12',
    },
        ...
        description: [
            {
                type: 'text',
                content: localize(
                    "No, we don't. However, you'll find quick strategies on Trader Mathews Bot that'll help you build your own trading bot for free."
                ),
            },
        ],
        search_id: 'faq-13',
    ...
    {
        title: localize('In which countries is Trader Mathews Bot available?'),
        description: [
            {
                type: 'text',
                content: localize(
    ...
    {
        title: localize('If I close my web browser, will Trader Mathews Bot continue to run?'),
        description: [
            {
                type: 'text',
                content: localize('No, Trader Mathews Bot will stop running when your web browser is closed.'),
            },
        ],
        search_id: 'faq-15',
    },
        ...
        description: [
            {
                type: 'text',
                content: localize(
                    "Three of the most commonly used strategies in automated trading are Martingale, D'Alembert, and Oscar's Grind — you can find them all ready-made and waiting for you in Trader Mathews Bot."
                ),
            },
        ],
        search_id: 'faq-16',
        ...
        description: [
            {
                type: 'text',
                content: localize(
                    '<a href="https://www.youtube.com/watch?v=QdI5zCkO4Gk&t=203s" rel="noopener noreferrer" target="_blank">Watch this video</a> to learn how to build a trading bot on Trader Mathews Bot. Also, <a href="https://deriv.com/blog/posts/build-a-basic-trading-bot-with-deriv-bot/" rel="noopener noreferrer" target="_blank">check out this blog post</a> on building a trading bot.'
                ),
            },
        ],
        search_id: 'faq-17',
...
export const quick_strategy_content: TQuickStrategyContent[] = [
    {
        ...
        content: [
            localize('Exploring the Martingale strategy in Trader Mathews Bot'),
    ...
    },
    {
        ...
        content: [
            localize('Exploring the D’Alembert strategy in Trader Mathews Bot'),
    ...
    },
    {
        ...
        content: [
            localize('Exploring the Oscar’s Grind strategy in Trader Mathews Bot'),
    ...
    },
    {
        ...
        content: [
            localize('Exploring the Reverse Martingale strategy in Trader Mathews Bot'),
    ...
    },
    {
        ...
        content: [
            localize('Exploring the Reverse D’Alembert strategy in Trader Mathews Bot'),
    ...
    },
    {
        ...
        content: [localize('Exploring the 1-3-2-6 strategy in Trader Mathews Bot'), localize('An example of 1-3-2-6 strategy')],
