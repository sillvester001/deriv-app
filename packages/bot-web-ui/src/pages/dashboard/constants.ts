...
export const SIDEBAR_INTRO: TSidebarItem[] = [
    {
        label: localize('Welcome to Trader Mathews Bot!'),
        content: [
            {
                data: localize(
    ...
    },
    {
        ...
        content: [{ data: localize('Trader Mathews Bot - your automated trading partner') }],
        link: true,
    },
    {
        label: localize('FAQs'),
        content: [
            {
                data: localize('What is Trader Mathews Bot?'),
                faq_id: 'faq-0',
            },
            {
